...
<table>
    ...
    <tr>
     ...
     <tr>
        <td>CustomerDataService.add(CustomerPO upo)</td>
        <td>插入单一持久化对象</td>
    </tr>
     <tr>
    ...
    <tr>
        <td>CustomerDataService.modify(CustomerPO upo)</td>
        <td>更新单一持久化对象</td>
    </tr>
</table>
...
<caption>表15 Inibl模块的接口规范 </caption>  
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage create(CommodityVO[] com_info, AccountVO[] acc_info, CustomerVO[] cus_info)</td>
    </tr>
    <tr>
        <td>前置条件</td>
        <td>启动期初建账定任务</td>
