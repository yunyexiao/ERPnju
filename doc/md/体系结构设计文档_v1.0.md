...
<caption>表13 Commoditybl模块的接口规范 </caption>  
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public CommodityVO findById(string id)</td>
    </tr>
    <tr>
        <td>前置条件</td>
        <td>启动商品管理任务</td>
    ...
    <tr>
     ...
     <tr>
        <td rowspan="3">Commodity.findByKeywords</td>
        <td>语法</td>
        <td>public CommodityVO findByKeywords(string name, string keyword)</td>
    </tr>
    <tr>
        <td>前置条件</td>
        <td>启动商品管理任务</td>
