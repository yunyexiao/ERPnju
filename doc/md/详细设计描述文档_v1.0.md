...
<centre>图4-1-0-1  LogBL模块各个类的设计</centre>  
InitBL模块的各个类的职责如表4-1-0-1所示   
<centre>表4-1-0-1  LogBL模块各个类的职责</centre>  
...
#### 4.1.6.2整体结构  
根据体系结构的设计，快递物流系统选择分层体系结构风格，将系统分为 3 层（展示层、业务逻辑层、数据层）,很好地示意了整个高层抽象。展示层包含GUI 页面的实现，业务逻辑层包含业务逻辑处理的实现，数据层负责数据的持久化和访问。每一层之间为了增加灵活性，添加了接口，比如在展示层和业务逻辑层之间添加blservice.billblservice.BillBLService接口，在业务逻辑层和数据层之间添加dataservice.billdataservice.BillDataService 接口。BillCreation用于处理不同性质的单据创建。BillList和BillListItem的添加是单据记录的容器类。SpecialSettle是一个接口，为销售单提供特殊的优惠结算方法，创建销售单时BillList继承该接口。BillPO是作为单据记录的持久化对象被添加到设计模型中的。CommodityInfo,UserInfo,AccountInfo,PromotionInfo,CustomerInfo都是根据接口最小化原则而产生的接口。
...
<table>
    ...
    <tr>
        <td>BillEdit</td>
        <td>单据编辑的领域模型对象，持有单据的编号、操作人、详细内容、状态等通用信息，和编辑单据的通用方法，可以帮助完成单据编辑所需要的服务</td>
    </tr>
    <tr>
        <td>BillList</td>
...
<caption>表2 BillEdit的接口规范 </caption> 
    ...
    <tr>
        <td rowspan="3">BillEdit.submitBill</td>
        <td>语法</td>
...
<table>
<caption>表3 BillList的接口规范 </caption> 
    <tr>
        <td colspan="3"><strong><div class="text" style=" text-align:center;">提供的接口（供接口）</div></strong></td>
    </tr>
     <tr>
...
<table>
<caption>表4 SpecialSettle的接口规范 </caption> 
    <tr>
        <td colspan="3"><strong><div class="text" style=" text-align:center;">提供的接口（供接口）</div></strong></td>
    </tr>
     <tr>
        <td rowspan="3">SpecialSettle.getBestPromotion</td>
        <td>语法</td>
    ...
    <tr>
     ...
     <tr>
        <td rowspan="3">SpecialSettle.getFinalTotal</td>
        <td>语法</td>
...
<table>
<caption>表5 BillLineItem的接口规范 </caption> 
    <tr>
        <td colspan="3"><strong><div class="text" style=" text-align:center;">提供的接口（供接口）</div></strong></td>
    </tr>
     <tr>
...
<table>
<caption>表6 BillManage的接口规范 </caption> 
    <tr>
        <td colspan="3"><strong><div class="text" style=" text-align:center;">提供的接口（供接口）</div></strong></td>
    </tr>
     <tr>
        <td rowspan="3">BillManage.getBillId</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">BillManage.deleteBill</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">BillManage.examineBill</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">BillManage.offsetBill</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">BillManage.copyBill</td>
        <td>语法</td>
...
<table>
<caption>表7 BillExamine的接口规范 </caption> 
    <tr>
        <td colspan="3"><strong><div class="text" style=" text-align:center;">提供的接口（供接口）</div></strong></td>
    </tr>
    <tr>
...
<table>
<caption>表8 BillSearch的接口规范 </caption> 
    <tr>
        <td colspan="3"><strong><div class="text" style=" text-align:center;">提供的接口（供接口）</div></strong></td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <tr>
        ...
        <td>语法</td>
        <td>public List&ltBillVO&gt findByTime(String startTime,String endTime)</td>
    </tr>
    <tr>
        <td>前置条件</td>
        <td>输入符合输入规则</td>
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public List&ltBillVO&gt findByCommodity(String comId)</td>
    </tr>
    <tr>
        <td>前置条件</td>
        <td>输入符合规则</td>
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public List&ltBillVO&gt findByType(String type)</td>
    </tr>
    <tr>
        <td>前置条件</td>
        <td>输入符合规则</td>
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public List&ltBillVO&gt findByType(String name)</td>
    </tr>
    <tr>
        <td>前置条件</td>
        <td>输入符合规则</td>
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public List&ltBillVO&gt findByStore(String store)</td>
    </tr>
    <tr>
        <td>前置条件</td>
        <td>输入符合规则</td>
    ...
    <tr>
     ...
     <tr>
        ...
        <td>语法</td>
        <td>public List&ltBillVO&gt getAll()</td>
    </tr>
    <tr>
        <td>前置条件</td>
        <td>输入符合规则</td>
