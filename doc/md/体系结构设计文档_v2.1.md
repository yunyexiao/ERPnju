...
<caption>表11 Billbl模块的接口规范 </caption> 
   ...
   <tr>
        <td rowspan="3">Bill.submitBill</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">Bill.getListTotal</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">Bill.getBestPromotion</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">Bill.getFinalTotal</td>
        <td>语法</td>
    ...
    <tr>
     ...
     <tr>
        <td rowspan="3">Bill.getItemTotal</td>
        <td>语法</td>
    ...
    <tr>
     ...
     <tr>
        <td rowspan="3">Bill.getBillId</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">Bill.deleteBill</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">Bill.offsetBill</td>
        <td>语法</td>
    ...
    <tr>
     ...
     <tr>
        <td rowspan="3">Bill.examineBill</td>
        <td>语法</td>
    ...
    <tr>
     ...
     <tr>
        <td rowspan="3">Bill.findByTime</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">Bill.findByCommodity</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">Bill.findByType</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">Bill.findBySalesman</td>
        <td>语法</td>
    ...
    <tr>
        <td rowspan="3">Bill.findByStore</td>
        <td>语法</td>
