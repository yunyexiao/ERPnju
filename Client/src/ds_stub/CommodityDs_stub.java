...
public class CommodityDs_stub implements CommodityDataService {
    ...
    public ArrayList<CommodityPO> getAllCommodity() throws RemoteException {
        ...
        result.add(new CommodityPO("002-20171127-00001", "交通信号灯", "TBD", "A", "特殊用途灯具", "001-20171127-00021"
            , 2000L, 200L, 120.0, 340.0, 120.0, 320.0));
        result.add(new CommodityPO("002-20171127-00002", "de-light", "TDD", "A", "inspectional", "001-20171127-00539"
