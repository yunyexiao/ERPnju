...
public class SalesReturnBillDs_stub implements SalesReturnBillDataService {
    ...
    public SalesReturnBillDs_stub(){
        ...
        ArrayList<SalesReturnBillItemsPO> items1 = new ArrayList<>();
        items1.add(new SalesReturnBillItemsPO("000001", "", 100, 50.0, 5000.0));
        items1.add(new SalesReturnBillItemsPO("000002", "", 20, 100.0, 2000.0));
        BILLS.add(new SalesReturnBillPO(
            "2017-12-09", "21:03:23", "00123", "0002", BillPO.PASS,
            "000001", "", "", "00012", 7000.0, 6800.0, items1
        ));
        
        ArrayList<SalesReturnBillItemsPO> items2 = new ArrayList<>();
        items2.add(new SalesReturnBillItemsPO("000003", "", 30, 80.0, 2400.0));
        items2.add(new SalesReturnBillItemsPO("000004", "", 40, 60.0, 2400.0));
        BILLS.add(new SalesReturnBillPO(
            "2017-12-11", "12:23:28", "08193", "0007", BillPO.COMMITED,
            "000002", "", "", "00312", 4800.0, 3800.0, items2
        ));
        
        ArrayList<SalesReturnBillItemsPO> items3 = new ArrayList<>();
        items3.add(new SalesReturnBillItemsPO("000002", "", 10, 100.0, 1000.0));
        items3.add(new SalesReturnBillItemsPO("000003", "", 70, 120.0, 8400.0));
        BILLS.add(new SalesReturnBillPO(
