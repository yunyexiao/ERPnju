...
public class PurchaseBillPO implements Serializable{
	...
	public PurchaseBillPO(String billId, String supplierId, String supplierName, String operatorId, String operatorName,
			String remark, String condition, String time, double sum) {
		super();
		this.billId = billId;
